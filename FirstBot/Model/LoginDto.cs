...
namespace IO.Swagger.Model
{
    ...
    public partial class LoginDto :  IEquatable<LoginDto>, IValidatableObject
    {
        ...
        public LoginDto(string login = default(string), string password = default(string))
        {
            // to ensure "login" is required (not null)
            if (login == null)
            {
                throw new InvalidDataException("login is a required property for LoginDto and cannot be null");
            }
            else
            {
                this.Login = login;
